...
# text_file_path = r"D:\Justin\Audio2Face\Postman\TTS_Voice_001_M0.txt"
# data_str=None
# with open(text_file_path, 'r') as f:
#     data_str = f.readlines()

wav_file = r"Z:\DigitalHuman\rvh\ml\yehunhwang\data\wav\TTS_Voice_002.wav"


with open(wav_file, 'rb') as f:
    getdata = requests.post('http://192.168.10.230:8000/wav_to_lips', files={'file': f})

data = np.array(getdata.json())
print(data.shape)

# # 텍스트를 저장할 파일을 엽니다. 
# file = open(r"Z:\DigitalHuman\rvh\ml\yehunhwang\data\numpy\temp\TTS_Voice_002_M0.json", "w")
